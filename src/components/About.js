...
const About = props => (
  <section id="about">
    ...
    <div class="row">
      <div class="col-1-2">
        <p>
          I'm a web developer with a <strong>3 years professional experience</strong>.
          I love things that looks nice and feels right.
        </p>
        <p>
          These days I mostly do <strong>front-end</strong> stuff,
          and I'm experimenting with <strong>datavisulization</strong>.
        ...
        <p>
          Nevertheless I can also work server-side and write some general-use scripts, thanks
        ...
        <p>
          Alongside to my developer experience, I also studied <strong>UX design</strong> and
          a bit of <strong>graphic design</strong>. I have a very humble,
           "see if it sticks" approach to both of theses fields, and I love
           working with talented people and learning from them.
        </p>
      </div>
      <div class="col-1-2">
        <p>My most important work experiences : </p>
        <ul>
          <li>
        ...
        <ul>
          <li>
            <strong>MMI Master's Degree (dev + ux + graphic design)</strong><br/>
          ...
          <li>
            <strong>Research in Communication Master's degree</strong><br/>
